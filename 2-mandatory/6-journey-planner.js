...
*/
function getTransportModes(transport) {return transport.slice(1)}
...
*/
function isAccessibleByTransportMode(transport,oneMode) { return transport.includes(oneMode)}
